...
typedef struct __mavlink_radio_status_t {
 ...
 uint8_t rssi; /*<  Local receive signal strength*/
 uint8_t remrssi; /*<  Remote receive signal strength*/
 uint8_t txbuf; /*< [%] Remaining free transmitter buffer space*/
 uint8_t noise; /*<  Local background noise level*/
 ...
 *
 * @param rssi  Local receive signal strength
 * @param remrssi  Remote receive signal strength
 * @param txbuf [%] Remaining free transmitter buffer space
 * @param noise  Local background noise level
 ...
 *
 * @return  Local receive signal strength
 */
 ...
 *
 * @return  Remote receive signal strength
 */
 ...
 *
 * @return  Local background noise level
 */
